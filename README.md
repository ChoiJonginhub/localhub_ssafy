...
**Seoul Connect**는 공공데이터를 활용하여 서울 시민과 관광객이 서울의 다양한 지역 정보를 자유롭게 공유하고 활용할 수 있도록 지원하는 **서울 관광 & 커뮤니티 플랫폼**입니다.

단순한 정보 제공 서비스를 넘어, 사용자의 위치와 관심사에 맞는 관광지, 축제, 맛집, 지역 커뮤니티 정보를 한곳에서 연결하는 **서울 맞춤 스마트 라이프 가이드**를 지향합니다.

사용자는 별도의 회원가입 없이 게시글을 작성하고 지역 정보를 공유할 수 있으며, AI 챗봇을 통해 서울의 관광 명소, 축제 일정, 맛집 추천 등 다양한 정보를 자연어로 쉽고 빠르게 탐색할 수 있습니다.

또한 지도 기반 시각화와 지역 커뮤니티 기능을 통해 서울을 방문하는 관광객에게는 편리한 여행 동반자로, 서울 시민에게는 생활 밀착형 지역 정보 플랫폼으로서의 가치를 제공합니다.

본 프로젝트는 SSAFY 팀 프로젝트 과제로 진행되었으며, 공공데이터 활용 서비스 설계 경험과 AI 기술을 활용한 사용자 중심 서비스 개발 역량 강화를 목표로 개발되었습니다.
